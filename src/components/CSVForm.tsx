...
import { Card, Text, Button, Link, Table, Loader } from '@gnosis.pm/safe-react-components';
...
export const CSVForm = (props: CSVFormProps) => {
    ...
    <Card>
        <Form>
          ...
          <TextField variant="outlined" label="CSV" onChange={(event) => props.onChange(event.target.value)} value={props.csvText} multiline rows={6} />
          <div>
